...
func (m *mockEventRepo) Insert(_ context.Context, _ *domain.Event) error {
	return m.insertErr
}
func (m *mockEventRepo) FindByID(_ context.Context, _ string) (*domain.Event, error) {
	return nil, domain.ErrNotFound
}
func (m *mockEventRepo) UpdateStatus(_ context.Context, _ string, _ domain.EventStatus) error {
	return nil
}
func (m *mockEventRepo) IncrementRetry(_ context.Context, _ string) error { return nil }
func (m *mockEventRepo) ListByStatus(_ context.Context, _ domain.EventStatus, _ int) ([]*domain.Event, error) {
	return nil, nil
}
